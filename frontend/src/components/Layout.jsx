  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[260px_1fr]">
      <aside className="glass-panel p-6 flex flex-col gap-6">
        ...
        <div className="mt-auto data-card p-4 text-sm">
        ...
        <Link
          to="/dashboard"
          className="inline-flex items-center justify-center rounded-full bg-wave text-white px-4 py-2 text-sm shadow-soft"
        >
          New Schema
        </Link>
      </aside>
